    ...
    do
    {
        ...
        */
        ...
        for(int y=ROW-2; y>0; y--)
        {
          ...
          /*      if(tab2D[nmap][y][x]== 'v' && tab2D[nmap][y-1][x]== 'E' )   SI LASER ENNEMI TOUCHE UN ENNEMI ALORS !
                {
                    tab2D[nmap][y][x]=' ';
                    tab2D[nmap][y+1][x]='v';
                }*/
        ...
        for(int y=0; y<ROW-2; y++)
        {
            for(int x=0; x < COL; x++)
            {
                if ( (rand() % 30) > 15 && (tab2D[nmap][y][x] == 'E') && (rand() % 30) > 28 && (tab2D[nmap][y+2][x] != 'E') && (tab2D[nmap][y+1][x] != 'E') && (tab2D[nmap][y+1][x] != '^'))
                {
                    tab2D[nmap][y+1][x] ='v';
                }
            }
        ...
        if (temp % 7 == 0)
        {
            if(position_E == 2)
            {
                for (int x = 1; x < COL-1; x ++)
                {
                    for (int y = 1; y < ROW; y ++)
                    {
                        if (moove_E == 1 && (tab2D[nmap][y-1][x+1] == 'E'))
                        {
                            tab2D[nmap][y][x] = tab2D[nmap][y-1][x+1];
                            tab2D[nmap][y-1][x+1] = ' ';
                        }
                        else if (moove_E == 0 && (tab2D[nmap][y][x+1] == 'E'))
                        {
